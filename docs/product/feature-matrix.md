...
- No full end-to-end verification coverage inside this repo snapshot.
- No guarantee that historical filenames referenced by legacy tests still exist.
...
- Spec docs cover actual source files and current repository drift.
