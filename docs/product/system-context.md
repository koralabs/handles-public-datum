...
### File and Test Drift
The current repository contains test references to absent files and an apparent missing constant in the validator source. Those issues affect maintainers more than end users, but in system-context terms they reduce change confidence and should influence how reviewers interpret local validation results.
